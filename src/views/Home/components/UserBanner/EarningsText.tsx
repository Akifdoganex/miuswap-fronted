...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MIU pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MIU pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MIU pool', data)
  }
